        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UrlLImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Artisans_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtisanPortfolios", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    IsServiceOrder = table.Column<bool>(type: "bit", nullable: false),
                    ArtisanId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 9, null, "منجد" },
                    { 10, null, "سيراميك" },
                    { 11, null, "أمن وأنظمة ذكية" },
                    { 12, null, "عامل بناء" },
                    { 13, null, "صيانة أجهزة كهربائية" },
                    { 14, null, "سواق نقل" },
                    { 15, null, "تكسير وإزالة" },
                    { 16, null, "الومنتال" },
