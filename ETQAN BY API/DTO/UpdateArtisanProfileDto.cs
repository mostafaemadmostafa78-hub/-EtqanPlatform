...
namespace ETQAN_BY_API.DTO
{
    public class UpdateArtisanProfileDto
    {
        ...
        public string? CurrentPassword { get; set; }    // 14. كلمة السر الحالية 
        public string? NewPassword { get; set; }     // 15. كلمة السر الجديدة
        public string? ConfirmPassword { get; set; }  // 16. تأكيد كلمة السر الجديدة
